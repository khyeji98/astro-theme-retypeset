...
export const themeConfig: ThemeConfig = {
  ...
  site: {
    ...
    title: '김혜지 블로그',
    // site subtitle
    subtitle: 'Tech Blog of iOS Developer',
    // site description
    description: '',
  ...
  global: {
    ...
    dateFormat: 'YYYY년 MM월 DD일', // YYYY-MM-DD, MM-DD-YYYY, DD-MM-YYYY, MONTH DAY YYYY, DAY MONTH YYYY
  ...
  comment: {
    ...
    // https://giscus.app/
    giscus: {
      repo: 'khyeji98/giscus-comments',
      repoId: 'R_kgDOP4CV3Q',
      category: 'Comments',
      categoryId: 'DIC_kwDOP4CV3c4Cv9z_',
      mapping: 'pathname',
      strict: '0',
      reactionsEnabled: '1',
      emitMetadata: '0',
  ...
  footer: {
    ...
    links: [
      ...
      {
        name: 'GitHub',
        url: 'https://github.com/khyeji98',
      },
      {
        name: 'Email',
        url: 'gpwl98wkd@gmail.com',
      },
      // {
      //   name: 'X',
